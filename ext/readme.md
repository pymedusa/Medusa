...
:: | <code><b>configparser</b>.py</code><br>`configparser.pth`<br>`backports.configparser` | [3.7.1](https://pypi.org/project/configparser/3.7.1/) | `adba` | **ext2** | `configparser.pth` was renamed from `configparser-3.5.0-py2.7-nspkg.pth`
