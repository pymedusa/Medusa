...
ext | `requests-toolbelt` | [0.9.1](https://pypi.org/project/requests-toolbelt/0.9.1/) | `<UPDATE-ME>` | Module: `requests_toolbelt`
...
ext | `tmdbsimple` | [2.2.6](https://pypi.org/project/tmdbsimple/2.2.6/) | **`medusa`** | -
