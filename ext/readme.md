...
:: | <code><b>configparser</b>.py</code><br>`configparser.pth`<br>`backports.configparser` | [3.5.1](https://pypi.org/project/configparser/3.5.1/) | `adba` | **ext2** | `configparser.pth` was renamed from `configparser-3.5.0-py2.7-nspkg.pth`
...
:: | `PyGithub` | [1.43.4](https://pypi.org/project/PyGithub/1.43.4/) | **`medusa`** | **ext2 ext3** | Module: `github`<br>**Removed tests**
