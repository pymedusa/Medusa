...
class Repository(github.GithubObject.CompletableGithubObject):
    ...
    def create_git_release(self, tag, name, message, draft=False, prerelease=False, target_commitish=github.GithubObject.NotSet):
        ...
        assert target_commitish is github.GithubObject.NotSet or isinstance(target_commitish, (str, github.Branch.Branch, github.Commit.Commit, github.GitCommit.GitCommit)), target_commitish
        post_parameters = {
            "tag_name": tag,
            "name": name,
            "body": message,
    ...
    def get_views_traffic(self, per=github.GithubObject.NotSet):
        ...
        """
        assert per is github.GithubObject.NotSet or (isinstance(per, str) and (per == "day" or per == "week")), "per must be day or week, day by default"
        url_parameters = dict()
