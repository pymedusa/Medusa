    ...
    addShows: {
        init: function() {
            ...
            $.fn.loadRemoteShows = function(path, loadingTxt, errorTxt) {
                $(this).html('<img id="searchingAnim" src="images/loading32' + SICKRAGE.info.themeSpinner + '.gif" height="32" width="32" />&nbsp;' + loadingTxt);
                $(this).load(path + ' #container', function(response, status) {
                    if (status === 'error') {
        ...
        newShow: function() {
            ...
            function searchIndexers() {
                ...
                $('#searchResults').empty().html('<img id="searchingAnim" src="images/loading32' + SICKRAGE.info.themeSpinner + '.gif" height="32" width="32" /> searching ' + searchingFor + '...');
                        ...
                        if (data.results.length === 0) {
                            ...
                            $.each(data.results, function(index, obj) {
                                ...
                                if (data.langid && data.langid !== '') {
                                    resultStr += '<a href="' + SICKRAGE.info.anonRedirect + obj[2] + obj[3] + '&lid=' + data.langid + '" onclick=\"window.open(this.href, \'_blank\'); return false;\" ><b>' + obj[4] + '</b></a>';
                                } else {
                                    resultStr += '<a href="' + SICKRAGE.info.anonRedirect + obj[2] + obj[3] + '" onclick=\"window.open(this.href, \'_blank\'); return false;\" ><b>' + obj[4] + '</b></a>';
                                }
