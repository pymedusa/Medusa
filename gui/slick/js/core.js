                ...
                function responsive(){
                    ...
                    if (resolution < 979) {
                      ...
                      if( $('.select-menu').length === 0 ) {
                        ...
                        select.addClass('form-control form-control-inline input-sm');
                        var option = $('<option></option>').text('====   Select Action   ====');
                        ...
                        $('#navSelect').text('SubMenu: ');
                        $('#navSelect').append(select);
                      }
