...
<div ng-controller="configController">
    <div ng-controller="configPostProcessingController">
        <div id="content960">
                                    ...
                                    <div id="naming_key" class="nocheck" style="display: none;">
                                          <table class="Key">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                  <td class="align-right"><i class="glyphicon glyphicon-info-sign" title="'Medusa' is used in place of RLSGROUP if it could not be properly detected"></i> <b>Release Group:</b></td>
                                                  <td>%RG</td>
                                                  <td>RLSGROUP</td>
                                                </tr>
                                                <tr class="even">
