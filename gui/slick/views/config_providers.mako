                    ...
                    <fieldset class="component-group-list">
                        ...
                        % for curProvider in sickbeard.providers.sortedProviderList():
                            ...
                            <li class="ui-state-default ${('nzb-provider', 'torrent-provider')[bool(curProvider.provider_type == GenericProvider.TORRENT)]}" id="${curName}">
                                ...
                                <span class="${('','ui-icon enable-confirmed-torrents-icon pull-right')[(hasattr(curProvider, 'ranked') and bool(curProvider.ranked)) or (hasattr(curProvider, 'confirmed') and bool(curProvider.confirmed))]}" style="vertical-align:middle;"></span>
                            </li>
                        % endfor
                        </ul>
