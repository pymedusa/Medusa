...
##                 <a href="#/displayShow?showId=${curShow.indexerid}"><img alt="" class="show-image" src="${srRoot}/showPoster/?show=${curShow.indexerid}&amp;which=poster_thumb" /></a>
##             </div>
##
...
##         % else:
##         <a href="#/displayShow?showId=${curLoadingShow.show.indexerid}">${curLoadingShow.show.name}</a>
##         % endif
##         </td>
##         <td></td>
##         <td></td>
...
##                     <a href="#/displayShow?showId=${curShow.indexerid}" title="${curShow.name}">
##                         <img src="${srRoot}/showPoster/?showId=${curShow.indexerid}&amp;which=poster_thumb" class="${sickbeard.HOME_LAYOUT}" alt="${curShow.indexerid}"/>
##                     </a>
##                     <a href="#/displayShow?showId=${curShow.indexerid}" style="vertical-align: middle;">${curShow.name}</a>
##                 </div>
##             </td>
...
##                     <a href="#/displayShow?showId=${curShow.indexerid}">
