...
from .readers import *
import importlib.resources as resources  # Replacing pkg_resources
...
def get_matroska_specs(webm_only=False):
    ...
    """
    specs = {}
    with resources.open_text(__name__, 'specs/matroska.xml') as resource:  # Updated to use importlib.resources
