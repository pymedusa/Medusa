...
class Application(object):
    ...
    def initialize(self, console_logging=True):
        ...
        with app.INIT_LOCK:
            ...
            app.SHOWLIST_DEFAULT_ANIME = check_setting_list(app.CFG, 'ANIME', 'showlist_default_anime', [])
    ...
    def save_config():
        ...
        new_config['ANIME']['showlist_default_anime'] = list(app.SHOWLIST_DEFAULT_ANIME)
