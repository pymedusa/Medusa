...
download_checker_scheduler = None
...
TORRENT_DOWNLOAD_EXPIRE_HOURS = 20
NZB_DOWNLOAD_EXPIRE_HOURS = 40
EXPIRE_STATUS_PREVIOUS = 1
EXPIRE_STATUS_DEFAULT = 2
TORRENT_DOWNLOAD_EXPIRE_MODE = 1  # 1 = revert to previous status, 2 = revert to default status
NZB_DOWNLOAD_EXPIRE_MODE = 0
TORRENT_DOWNLOAD_EXPIRE_NOTIFY = False
NZB_DOWNLOAD_EXPIRE_NOTIFY = False
...
DEFAULT_DOWNLOAD_CHECKER_FREQUENCY = 60
...
MIN_DOWNLOAD_CHECKER_FREQUENCY = 30
...
DOWNLOAD_CHECKER_FREQUENCY = None
