...
__all__ = ['TvdbError', 'TvdbUserAbort', 'TvdbShowNotFound', 'TvdbShowIncomplete',
           'TvdbSeasonNotFound', 'TvdbEpisodeNotFound', 'TvdbAttributeNotFound']


class TvdbException(Exception):
    """Any exception generated by TvdbApi."""
...
class TvdbShowIncomplete(TvdbException):
