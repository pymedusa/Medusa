...
class AvistaZProvider(TorrentProvider):
    """AvistaZ Torrent provider."""

    def __init__(self):
        """Initialize the class."""
        super(AvistaZProvider, self).__init__('AvistaZ')
