    ...
    def search(self, search_strings, age=0, ep_obj=None, **kwargs):
        ...
        for mode in search_strings:
            ...
            for search_string in search_strings[mode]:
                ...
                if not jdata.get('Matches') and 'error' in jdata:
                    log.warning('No results returned. Error: {error}', {'error': jdata['error']})
                    break
        ...
        for group in group_rows:
            ...
            for row in torrent_rows:
                try:
                    ...
                    log.warning('Error trying to parse result. Error: {error}', {'error': error})
