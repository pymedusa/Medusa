...
class SeriesHandler(BaseRequestHandler):
    ...
    def _get(self, series_slug, path_param=None):
    ...
    def _post(self, series_slug=None, path_param=None):
        """Add a new series."""
    ...
    def _patch(self, series_slug, path_param=None):
        """Patch series."""
        if not series_slug:
    ...
    def _delete(self, series_slug, path_param=None):
        """Delete the series."""
        if not series_slug:
