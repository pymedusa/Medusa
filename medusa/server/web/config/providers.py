            ...
            for curNewznabProviderStr in newznab_string.split('!!!'):
                ...
                if cur_id in newznab_provider_dict:
                    ...
                    try:
                        ...
                        newznab_provider_dict[cur_id].session.police.enable_api_hit_cooldown = newznab_provider_dict[
                            cur_id].enable_api_hit_cooldown
                        newznab_provider_dict[cur_id].police.configure()
                    except (AttributeError, KeyError):
                    ...
                    try:
                        ...
                        newznab_provider_dict[cur_id].session.police.api_hit_limit = newznab_provider_dict[cur_id].api_hit_limit
                        newznab_provider_dict[cur_id].session.police.configure_hooks()
                    except (AttributeError, KeyError):
                    ...
                    try:
                        ...
                        newznab_provider_dict[cur_id].session.police.daily_reserve_calls = newznab_provider_dict[
