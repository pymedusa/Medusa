...
class History(object):
    ...
    def get(self, limit=100, action=None):
        ...
        common_sql = 'SELECT show_name, showid, season, episode, h.quality, ' \
                     'action, provider, resource, date, h.proper_tags, h.manual_searched ' \
    ...
    action_fields = ('action', 'provider', 'resource', 'date', 'proper_tags', 'manual_searched')
