...
class TVShow(TVObject):
    ...
    def want_episode(self, season, episode, quality, forced_search=False, download_current_quality=False):
        ...
        manual_searched = sql_results[0][b'manual_searched']
    ...
    def get_overview(self, ep_status, backlog_mode=False, manual_searched=False):
        ...
        if backlog_mode:
            ...
            elif Quality.should_search(ep_status, self, manual_searched):
        ...
        if ep_status == WANTED:
            ...
            if Quality.should_search(ep_status, self, manual_searched):
                return Overview.QUAL
            else:
                return Overview.GOOD
        else:
                ...
                if app.SUBTITLES_MULTI or not rows[0][b'subtitles'] or not self.subtitles:
                    return [
                        ...
                        [self.indexerid, self.indexer, self.name, self.description, ','.join(self.subtitles),
                         ...
                         self.release_group, self.manual_searched, ep_id]]
                else:
