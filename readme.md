...
##### [SickRage Issue Tracker](https://github.com/pymedusa/medusa/issues)
...
A full list can be found here: [Link](https://github.com/pymedusa/medusa/wiki/SickRage-Search-Providers)
