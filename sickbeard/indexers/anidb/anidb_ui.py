...
"""Contains included user interface for anidb show selection"""

import logging
import warnings
from anidb_exceptions import anidb_userabort
    ...
    def selectSeries(self, allSeries):
        ...
        while True: # return breaks this loop
            try:
                ...
                raise anidb_userabort("User aborted (^c keyboard interupt)")
            except EOFError:
                raise anidb_userabort("User aborted (EOF received)")
            ...
            try:
                ...
                if ans == "q":
                    ...
                    raise anidb_userabort("User aborted ('q' quit command)")
                elif ans == "?":
                    print "## Help"
