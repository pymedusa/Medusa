...
class TVCache(object):
    ...
    def searchCache(self, episode, manual_snatch=False, downCurQuality=False):
        neededEps = self.findNeededEpisodes(episode, manual_snatch, downCurQuality)
    ...
    def findNeededEpisodes(self, episode, manual_snatch=False, downCurQuality=False):  # pylint:disable=too-many-locals, too-many-branches
        neededEps = {}
        cl = []
        ...
        for curResult in sql_results:
            ...
            if not showObj.wantEpisode(curSeason, curEp, curQuality, manual_snatch, downCurQuality):
