...
const init = () => {
    $('#tabs').tabs({
        collapsible: true,
        selected: (state.config.sortArticle ? -1 : 0)
    });
    ...
    $.fn.loadRemoteShows = function(path, loadingTxt, errorTxt) {
        $(this).html('<img id="searchingAnim" src="images/loading32' + state.components.themeSpinner + '.gif" height="32" width="32" />&nbsp;' + loadingTxt);
