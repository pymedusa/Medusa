...
const notifications = () => { // eslint-disable-line max-lines
    $('#testGrowl').on('click', function() {
        ...
        $('#testGrowl-result').html(state.components.loading);
        $.get('home/testGrowl', {
            host: growl.host,
    ...
    $('#testProwl').on('click', function() {
        ...
        $(this).prop('disabled', true);
        $('#testProwl-result').html(state.components.loading);
        $.get('home/testProwl', {
    ...
    $('#testKODI').on('click', function() {
        ...
        $(this).prop('disabled', true);
        $('#testKODI-result').html(state.components.loading);
        $.get('home/testKODI', {
            host: kodi.host,
    ...
    $('#testPHT').on('click', function() {
        ...
        $(this).prop('disabled', true);
        $('#testPHT-result').html(state.components.loading);
        $.get('home/testPHT', {
    ...
    $('#testPMS').on('click', function() {
        ...
        $(this).prop('disabled', true);
        $('#testPMS-result').html(state.components.loading);
        $.get('home/testPMS', {
    ...
    $('#testEMBY').on('click', function() {
        ...
        $(this).prop('disabled', true);
        $('#testEMBY-result').html(state.components.loading);
        $.get('home/testEMBY', {
            host: emby.host,
    ...
    $('#testBoxcar2').on('click', function() {
        ...
        $(this).prop('disabled', true);
        $('#testBoxcar2-result').html(state.components.loading);
    ...
    $('#testPushover').on('click', function() {
        ...
        $(this).prop('disabled', true);
        $('#testPushover-result').html(state.components.loading);
    ...
    $('#testLibnotify').on('click', () => {
        $('#testLibnotify-result').html(state.components.loading);
    ...
    $('#twitterStep1').on('click', () => {
        $('#testTwitter-result').html(state.components.loading);
    ...
    $('#settingsNMJ').on('click', () => {
        const nmj = {};
        if ($('#nmj_host').val()) {
            $('#testNMJ-result').html(state.components.loading);
    ...
    $('#settingsNMJv2').on('click', () => {
        const nmjv2 = {};
        if ($('#nmjv2_host').val()) {
            $('#testNMJv2-result').html(state.components.loading);
    ...
    $('#testFreeMobile').on('click', function() {
        ...
        $(this).prop('disabled', true);
        $('#testFreeMobile-result').html(state.components.loading);
    ...
    $('#testTelegram').on('click', function() {
        ...
        $(this).prop('disabled', true);
        $('#testTelegram-result').html(state.components.loading);
    ...
    $('#testSlack').on('click', function() {
        ...
        $(this).prop('disabled', true);
        $('#testSlack-result').html(state.components.loading);
        $.get('home/testslack', {
    ...
    $('#testTrakt').on('click', function() {
        ...
        $(this).prop('disabled', true);
        $('#testTrakt-result').html(state.components.loading);
        $.get('home/testTrakt', {
    ...
    $('#testEmail').on('click', () => {
        ...
        status.html(state.components.loading);
    ...
    $('#testNMA').on('click', function() {
        ...
        $(this).prop('disabled', true);
        $('#testNMA-result').html(state.components.loading);
        $.get('home/testNMA', {
    ...
    $('#testPushalot').on('click', function() {
        ...
        $(this).prop('disabled', true);
        $('#testPushalot-result').html(state.components.loading);
    ...
    $('#testPushbullet').on('click', function() {
        ...
        $(this).prop('disabled', true);
        $('#testPushbullet-result').html(state.components.loading);
