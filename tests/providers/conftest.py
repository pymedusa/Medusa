...
from medusa.providers.torrent import (anidex, elitetorrent, horriblesubs, limetorrents, newpct, rarbg, shanaproject,
...
PROVIDERS = (anidex, elitetorrent, horriblesubs, limetorrents, newpct, rarbg, shanaproject, thepiratebay,
             tokyotoshokan, torrent9, torrentz2, zooqle)
