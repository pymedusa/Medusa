...
def get_providers():
    from medusa.providers.torrent import (anidex, horriblesubs, limetorrents, nyaa, rarbg, shanaproject,
                                          thepiratebay, tokyotoshokan, torrentz2, zooqle)

    return (anidex, horriblesubs, limetorrents, nyaa, rarbg, shanaproject,
            thepiratebay, tokyotoshokan, torrentz2, zooqle)
