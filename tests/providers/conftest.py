...
from medusa.providers.torrent import (anidex, elitetorrent, horriblesubs, limetorrents, thepiratebay, torrentz2,
                                      zooqle)
...
PROVIDERS = (anidex, elitetorrent, horriblesubs, limetorrents, thepiratebay, torrentz2, zooqle)
