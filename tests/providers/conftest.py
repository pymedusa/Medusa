...
from medusa.providers.torrent import anidex, elitetorrent, horriblesubs, thepiratebay, torrentz2, zooqle
...
PROVIDERS = (anidex, elitetorrent, horriblesubs, thepiratebay, torrentz2, zooqle)
