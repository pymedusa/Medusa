...
def data(create_tvshow, create_tvepisode):
    ...
    return {
        ...
        'tvshow_properties': {
            'show': show_name,
            'year': show_year,
            'show_tvdb_id': tvshow.tvdb_id,
            'show_imdb_id': tvshow.imdb_id,
        },
        'tvepisode': tvepisode,
...
def _to_properties(video):
    return {
        ...
        'show_tvdb_id': video.show_tvdb_id,
        'show_imdb_id': video.show_imdb_id,
...
def test_refine__video_with_ids_skipping_tvepisode_info(data):
    # Given
    video = data['video']
    video.show_tvdb_id = 99
    video.tvdb_id = 88
    tvepisode = data['tvepisode']
    expected = dict(data['video_properties'], show_tvdb_id=video.show_tvdb_id, tvdb_id=video.tvdb_id)
