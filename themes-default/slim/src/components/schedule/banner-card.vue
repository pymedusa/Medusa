            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-bottom">
                        ...
                        <span class="title">Next Episode:</span> <span>{{episode.episodeSlug}}</span><span v-if="episode.epName"> - {{episode.epName}}</span>
                        <div class="clearfix">
                            <span class="title">Airs: </span><span class="airdate">{{fuzzyParseDateTime(episode.airdate)}}</span><span v-if="episode.network"> on {{episode.network}}</span>
                        </div>
                        <div class="clearfix">
