...
export const makeEpisodeRow = (indexerId, seriesId, season, episode, name, checked) => { // eslint-disable-line max-params
    let row = '';
...
export const makeSubtitleRow = (indexerId, seriesId, season, episode, name, subtitles, checked) => { // eslint-disable-line max-params
    let row = '';
    const series = indexerId + '-' + seriesId;
