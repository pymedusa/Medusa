                    ...
                    <ul class="dropdown-menu">
                        ...
                        % if app.SHOWS_RECENT:
                            ...
                            % for recentShow in app.SHOWS_RECENT:
                                <li><app-link data-indexer-to-name="${recentShow['indexer']}" href="home/displayShow?indexername=indexer-to-name&seriesid=${recentShow['indexerid']}"><i class="menu-icon-addshow"></i>&nbsp;${recentShow['name']|trim,h}</app-link></li>
                            % endfor
                        % endif
                    </ul>
