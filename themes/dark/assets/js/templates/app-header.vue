    ...
    <div class="container-fluid">
        ...
        <div v-if="auth.isAuthenticated" class="collapse navbar-collapse" id="main_nav">
            <ul class="nav navbar-nav navbar-right">
                <li @mouseover="toggleDropdown('home')" @mouseout="toggleDropdown('home')" id="NAVhome" class="navbar-split dropdown" :class="{ active: topMenu === 'home' }">
                ...
                <li @mouseover="toggleDropdown('manage')" @mouseout="toggleDropdown('manage')" id="NAVmanage" class="navbar-split dropdown" :class="{ active: topMenu === 'manage' }">
                ...
                <li @mouseover="toggleDropdown('config')" @mouseout="toggleDropdown('config')" id="NAVconfig" class="navbar-split dropdown" :class="{ active: topMenu === 'config' }">
                ...
                <li @mouseover="toggleDropdown('system')" @mouseout="toggleDropdown('system')" id="NAVsystem" class="navbar-split dropdown" :class="{ active: topMenu === 'system' }">
...
module.exports = {
    ...
    methods: {
        ...
        toggleDropdown(menu) {
            // Flip open/close status
            this.menusOpen[menu] = !this.menusOpen[menu];
        }
    }
};
</script>
