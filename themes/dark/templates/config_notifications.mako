...
window.app = new Vue({
    ...
    methods: {
        ...
        async testJoinApi() {
            const { api: joinApiKey } = this.notifiers.pushbullet;
            if (!joinApiKey) {
                        ...
                        <div class="col-xs-12 col-md-10">
                            <fieldset class="component-group-list">
                                ...
                                <div v-show="notifiers.join.enabled" id="content-use-join-client"> <!-- show based on notifiers.join.enabled -->
                                    ...
                                    <div class="testNotification" id="testJoin-resultsfsf">{{joinTestInfo}}</div>
...
=======
                    ...
                    <div class="component-group">
                        ...
                        <div class="component-group-desc-legacy">
>>>>>>> 4d0a3bde5c57a34dc57b92c3d0074d613e22fda6
