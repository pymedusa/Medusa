        ...
        <form action="manage/downloadSubtitleMissed" method="post">
            ...
            % for cur_series in sorted_show_ids:
                ...
                <tr id="${series_id}">
                    ...
                    <th colspan="3" style="text-align: left;"><app-link data-indexer-to-name="${cur_series[0]}" class="whitelink" href="home/displayShow?indexername=indexer-to-name&seriesid=${cur_series[1]}">
