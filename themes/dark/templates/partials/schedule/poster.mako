    ...
    <div class="tvshowDiv">
        ...
        <tr>
            <th rowspan="2" valign="top">
                <app-link href="home/displayShow?indexername=${indexer_id_to_name(cur_result['indexer'])}&showid=${cur_result['showid']}">
                    <img alt="" class="posterThumb" show="${cur_result['show_slug']}" asset="posterThumb"/>
                </app-link>
            </th>
