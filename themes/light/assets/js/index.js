...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _jquery = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n\nvar _jquery2 = _interopRequireDefault(_jquery);\n\n__webpack_require__(/*! tablesorter */ \"./node_modules/tablesorter/dist/js/jquery.tablesorter.combined.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n// eslint-disable-line import/no-unassigned-import\n\nexports.default = function () {\n    (0, _jquery2.default)('#failedTable:has(tbody tr)').tablesorter({\n        widgets: ['zebra'],\n        sortList: [],\n        headers: { 3: { sorter: false } }\n    });\n\n    (0, _jquery2.default)('#limit').on('change', function (event) {\n        window.location.href = (0, _jquery2.default)('base').attr('href') + 'manage/failedDownloads/?limit=' + (0, _jquery2.default)(event.currentTarget).val();\n    });\n\n    (0, _jquery2.default)('#submitMassRemove').on('click', function () {\n        var removeArr = [];\n\n        (0, _jquery2.default)('.removeCheck').each(function (index, element) {\n            if (element.checked === true) {\n                removeArr.push((0, _jquery2.default)(element).attr('id').split('-')[1]);\n            }\n        });\n\n        if (removeArr.length === 0) {\n            return false;\n        }\n\n        window.location.href = (0, _jquery2.default)('base').attr('href') + 'manage/failedDownloads?toRemove=' + removeArr.join('|');\n    });\n\n    if ((0, _jquery2.default)('.removeCheck').length !== 0) {\n        (0, _jquery2.default)('.removeCheck').each(function (index, element) {\n            var lastCheck = null;\n            (0, _jquery2.default)(element).on('click', function (event) {\n                if (!lastCheck || !event.shiftKey) {\n                    lastCheck = undefined;\n                    return;\n                }\n\n                var check = event.currentTarget;\n                var found = 0;\n\n                (0, _jquery2.default)(name + ':visible').each(function (index, element) {\n                    if (found === 1) {\n                        element.checked = lastCheck.checked;\n                    }\n                    if (found === 2) {\n                        return false;\n                    }\n\n                    if (element === check || element === lastCheck) {\n                        found++;\n                    }\n                });\n            });\n        });\n    }\n};\n\n//# sourceURL=webpack:///./src/manage/failed-downloads.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.subtitleMissed = exports.failedDownloads = undefined;\n\nvar _failedDownloads = __webpack_require__(/*! ./failed-downloads */ \"./src/manage/failed-downloads.js\");\n\nvar _failedDownloads2 = _interopRequireDefault(_failedDownloads);\n\nvar _subtitleMissed = __webpack_require__(/*! ./subtitle-missed */ \"./src/manage/subtitle-missed.js\");\n\nvar _subtitleMissed2 = _interopRequireDefault(_subtitleMissed);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nexports.failedDownloads = _failedDownloads2.default;\nexports.subtitleMissed = _subtitleMissed2.default;\n\n//# sourceURL=webpack:///./src/manage/index.js?");

/***/ }),

/***/ "./src/manage/subtitle-missed.js":
/*!***************************************!*\
  !*** ./src/manage/subtitle-missed.js ***!
  \***************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _jquery = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n\nvar _jquery2 = _interopRequireDefault(_jquery);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nexports.default = function () {\n    (0, _jquery2.default)('.allCheck').on('click', function (event) {\n        var element = event.currentTarget;\n        var seriesId = (0, _jquery2.default)(element).attr('data-indexer-id') + '-' + (0, _jquery2.default)(element).attr('data-series-id');\n        (0, _jquery2.default)('.' + seriesId + '-epcheck').prop('checked', (0, _jquery2.default)(element).prop('checked'));\n    });\n\n    (0, _jquery2.default)('.get_more_eps').on('click', function (event) {\n        var element = event.currentTarget;\n        var indexerId = (0, _jquery2.default)(element).attr('data-indexer-id');\n        var seriesId = (0, _jquery2.default)(element).attr('data-series-id');\n        var checked = (0, _jquery2.default)('#allCheck-' + indexerId + '-' + seriesId).prop('checked');\n        var lastRow = (0, _jquery2.default)('tr#' + indexerId + '-' + seriesId);\n        var clicked = (0, _jquery2.default)(element).data('clicked');\n        var action = (0, _jquery2.default)(element).attr('value');\n\n        if (clicked) {\n            if (action === 'Collapse') {\n                (0, _jquery2.default)('table tr').filter('.show-' + indexerId + '-' + seriesId).hide();\n                (0, _jquery2.default)(element).prop('value', 'Expand');\n            } else if (action === 'Expand') {\n                (0, _jquery2.default)('table tr').filter('.show-' + indexerId + '-' + seriesId).show();\n                (0, _jquery2.default)(element).prop('value', 'Collapse');\n            }\n        } else {\n            _jquery2.default.getJSON('manage/showSubtitleMissed', {\n                indexer: indexerId,\n                seriesid: seriesId,\n                whichSubs: (0, _jquery2.default)('#selectSubLang').val()\n            }, function (data) {\n                _jquery2.default.each(data, function (season, eps) {\n                    _jquery2.default.each(eps, function (episode, data) {\n                        lastRow.after(_jquery2.default.makeSubtitleRow(indexerId, seriesId, season, episode, data.name, data.subtitles, checked));\n                    });\n                });\n            });\n            (0, _jquery2.default)(element).data('clicked', 1);\n            (0, _jquery2.default)(element).prop('value', 'Collapse');\n        }\n    });\n\n    // Selects all visible episode checkboxes.\n    (0, _jquery2.default)('.selectAllShows').on('click', function () {\n        (0, _jquery2.default)('.allCheck').each(function (index, element) {\n            element.checked = true;\n        });\n        (0, _jquery2.default)('input[class*=\"-epcheck\"]').each(function (index, element) {\n            element.checked = true;\n        });\n    });\n\n    // Clears all visible episode checkboxes and the season selectors\n    (0, _jquery2.default)('.unselectAllShows').on('click', function () {\n        (0, _jquery2.default)('.allCheck').each(function (index, element) {\n            element.checked = false;\n        });\n        (0, _jquery2.default)('input[class*=\"-epcheck\"]').each(function (index, element) {\n            element.checked = false;\n        });\n    });\n};\n\n//# sourceURL=webpack:///./src/manage/subtitle-missed.js?");
