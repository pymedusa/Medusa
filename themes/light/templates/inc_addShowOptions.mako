...
%>
        ...
        <div class="field-pair alt">
            <label for="season_folders" class="clearfix">
                ...
                <span class="component-desc">
                    <input type="checkbox" name="season_folders" id="season_folders" ${'checked="checked"' if not app.FLATTEN_FOLDERS_DEFAULT or app.NAMING_FORCE_FOLDERS else ''} ${'disabled="disabled"' if app.NAMING_FORCE_FOLDERS else ''}/>
