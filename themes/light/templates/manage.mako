        ...
        <div class="col-md-12 horizontal-scroll">
            ...
            %>
                ...
                <%
                    ...
                    curUpdate = '<input type="checkbox" class="updateCheck" data-indexer-name=' + cur_show.indexer_name + ' data-show-id="' + str(cur_show.show_id) + '" id="update-' + str(cur_show.indexerid) + '" ' + ('', 'disabled="disabled" ')[disabled] + '/>'
                    ...
                    curRefresh = '<input type="checkbox" class="refreshCheck" data-indexer-name=' + cur_show.indexer_name + ' data-show-id="' + str(cur_show.show_id) + '" id="refresh-' + str(cur_show.indexerid) + '" ' + ('', 'disabled="disabled" ')[disabled] + '/>'
                    ...
                    curRename = '<input type="checkbox" class="renameCheck" data-indexer-name=' + cur_show.indexer_name + ' data-show-id="' + str(cur_show.show_id) + '" id="rename-' + str(cur_show.indexerid) + '" ' + ('', 'disabled="disabled" ')[disabled] + '/>'
                    ...
                    curSubtitle = '<input type="checkbox" class="subtitleCheck" data-indexer-name=' + cur_show.indexer_name + ' data-show-id="' + str(cur_show.show_id) + '" id="subtitle-' + str(cur_show.indexerid) + '" ' + ('', 'disabled="disabled" ')[disabled] + '/>'
                    ...
                    curDelete = '<input type="checkbox" class="confirm deleteCheck" data-indexer-name=' + cur_show.indexer_name + ' data-show-id="' + str(cur_show.show_id) + '" id="delete-' + str(cur_show.indexerid) + '" ' + ('', 'disabled="disabled" ')[disabled] + '/>'
                    disabled = app.show_queue_scheduler.action.isBeingRenamed(cur_show) or app.show_queue_scheduler.action.isInRenameQueue(cur_show) or app.show_queue_scheduler.action.isInRefreshQueue(cur_show)
                    curRemove = '<input type="checkbox" class="removeCheck" data-indexer-name=' + cur_show.indexer_name + ' data-show-id="' + str(cur_show.show_id) + '" id="remove-' + str(cur_show.indexerid) + '" ' + ('', 'disabled="disabled" ')[disabled] + '/>'
                    curImage = '<input type="checkbox" class="imageCheck" data-indexer-name=' + cur_show.indexer_name + ' data-show-id="' + str(cur_show.show_id) + '" id="image-' + str(cur_show.indexerid) + '" ' + '/>'
                %>
                <tr>
                    <td class="triggerhighlight" align="center" title="Edit"><input type="checkbox" class="editCheck" data-indexer-name="${cur_show.indexer_name}" data-show-id="${cur_show.show_id}" id="edit-${cur_show.show_id}" /></td>
                    <td class="tvShow triggerhighlight"><app-link href="home/displayShow?indexername=${cur_show.indexer_name}&showid=${cur_show.indexerid}">${cur_show.name}</app-link></td>
