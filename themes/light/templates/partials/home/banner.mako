            ...
            % if app.show_queue_scheduler.action.loadingShowList:
                ...
                % for cur_loading_show in app.show_queue_scheduler.action.loadingShowList:
                    ...
                    <tr>
                        ...
                        % else:
                        <app-link href="home/displayShow?indexername=${cur_loading_show.show.indexer_name}&showid=${cur_loading_show.show.show_id}">${cur_loading_show.show.name}</app-link>
                        % endif
                        </td>
                        <td></td>
                        <td></td>
                ...
                % endif
                    <td>
                        ...
                        <div class="imgbanner banner">
                            <app-link href="home/displayShow?indexername=${cur_show.indexer_name}&showid=${cur_show.show_id}">
                    ...
                    <td align="center">
                    % if cur_show.network:
                        <span title="${cur_show.network}" class="hidden-print"><img id="network" class="show-network-image" width="54" height="27" src="images/network/nonetwork.png" lazy="on" show="${cur_show.slug}" asset="network" alt="${cur_show.network}" title="${cur_show.network}" /></span>
                    ...
                    <td align="center">
                        ...
                        % endif
                        <app-link data-indexer-name="${indexerApi(cur_show.indexer).name}" href="${indexerApi(cur_show.indexer).config['show_url']}${cur_show.show_id}" title="${indexerApi(cur_show.indexer).config['show_url']}${cur_show.show_id}">
                    ...
                    <td align="center">
                        ...
                        <div class="progressbar hidden-print" style="position:relative;" data-show-id="${cur_show.show_id}" data-progress-percentage="${progressbar_percent}" data-progress-text="${download_stat}" data-progress-tip="${download_stat_tip}"></div>
