                ...
                <div class="aligner">
                    ...
                    <div class="poster-overlay">
                        <app-link href="home/displayShow?indexername=${cur_show.indexer_name}&seriesid=${cur_show.indexerid}">
                            <asset default-src="images/poster.png" show-slug="${cur_show.slug}" :lazy="false" type="posterThumb" cls="show-image" :link="false"></asset>
                        </app-link>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    % if cur_show.network:
                                        <span title="${cur_show.network}">
                                            <asset default-src="images/network/nonetwork.png" show-slug="${cur_show.slug}" :lazy="false" type="network" cls="show-network-image" :link="false" alt="${cur_show.network}" title="${cur_show.network}"></asset>
                                        </span>
                                    % else:
