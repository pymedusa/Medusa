        ...
        <div id="customQualityWrapper">
            <div style="padding-left: 0;" v-show="selectedQualityPreset === 0">
                ...
                <div style="text-align: left; float: left;">
                    <h5>Preferred</h5>
                    <select v-model="preferredQualities" name="preferred_qualities" multiple="multiple" :size="preferredQualityList.length" class="form-control form-control-inline input-sm" :disabled="allowedExplanation.length === 0">
