...
<div id="config-content">
    <table class="infoTable" cellspacing="1" border="0" cellpadding="0" width="100%">
        <tr v-if="release">
            ...
            <td>
                Branch: <a v-bind:href="sourceUrl + '/tree/' + branch" v-on:click="redirect">{{branch}}</a><br>
                Commit: <a v-bind:href="sourceUrl + '/commit/' + commitHash" v-on:click="redirect">{{commitHash}}</a><br>
                Version: <a v-bind:href="sourceUrl + '/releases/tag/' + release" v-on:click="redirect">{{release}}</a><br>
        ...
        <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
        <tr class="infoTableSeperator"><td>&nbsp;</td><td>&nbsp;</td></tr>
        <tr><td><i class="icon16-config-web"></i> Website:</td><td><a v-bind:href="githubUrl" rel="noreferrer" v-on:click="redirect">{{githubUrl}}</a></td></tr>
        <tr><td><i class="icon16-config-wiki"></i> Wiki:</td><td><a v-bind:href="wikiUrl" rel="noreferrer" v-on:click="redirect">{{wikiUrl}}</a></td></tr>
        <tr><td><i class="icon16-config-github"></i> Source:</td><td><a v-bind:href="sourceUrl" rel="noreferrer" v-on:click="redirect">{{sourceUrl}}</a></td></tr>
