    ...
    <div class="horizontal-scroll">
        <table id="showListTable${cur_list_type}" class="tablesorter ${'fanartOpacity' if app.FANART_BACKGROUND else ''}" cellspacing="1" border="0" cellpadding="0">
            ...
            <%
                ...
                show_size = 0
                download_stat_tip = ''
                if cur_show.series_id in show_stat:
                    cur_airs_next = show_stat[cur_show.series_id]['ep_airs_next']
                    cur_airs_prev = show_stat[cur_show.series_id]['ep_airs_prev']
                    cur_snatched = show_stat[cur_show.series_id]['ep_snatched']
                    if not cur_snatched:
                        cur_snatched = 0
                    cur_downloaded = show_stat[cur_show.series_id]['ep_downloaded']
                    if not cur_downloaded:
                        cur_downloaded = 0
                    cur_total = show_stat[cur_show.series_id]['ep_total']
                    if not cur_total:
                        cur_total = 0
                    show_size = show_stat[cur_show.series_id]['show_size']
                ...
                % endif
                    <td>
                        ...
                        <div class="imgbanner banner">
                            <a href="home/displayShow?indexername=${cur_show.indexer_name}&seriesid=${cur_show.series_id}">
