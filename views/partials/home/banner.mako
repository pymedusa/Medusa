        ...
        % endif
            <td>
                ...
                <div class="imgbanner banner">
                    ...
                    <img src="images/banner.png" data-src="api/v2/asset/show/${cur_show.indexerid}?type=banner&api_key=${app.API_KEY}" class="banner" alt="${cur_show.indexerid}" title="${cur_show.name}"/>
                    </a>
                </div>
            </td>
            <td align="center">
            % if cur_show.network:
                <span title="${cur_show.network}" class="hidden-print"><img id="network" class="show-network-image" width="54" height="27" src="images/network/nonetwork.png" data-src="api/v2/asset/show/${cur_show.indexerid}?type=network&api_key=${app.API_KEY}" alt="${cur_show.network}" title="${cur_show.network}" /></span>
