        ...
        <div class="show-container" id="show${cur_show.indexerid}" data-name="${cur_show.name}" data-date="${data_date}" data-network="${cur_show.network}" data-progress="${progressbar_percent}" data-indexer="${cur_show.indexer}">
            <div class="aligner">
                ...
                <div class="poster-overlay">
                    <a href="home/displayShow?show=${cur_show.indexerid}"><img alt="" class="show-image" src="images/poster.png" layz="on" asset="show/${cur_show.indexerid}?type=posterThumb&api_key=${app.API_KEY}"/></a>
                </div>
            </div>
                    ...
                    <div class="show-details">
                        <table class="show-details ${'fanartOpacity' if app.FANART_BACKGROUND else ''}" width="100%" cellspacing="1" border="0" cellpadding="0">
                            <tr>
                                ...
                                <td class="show-table">
                                % if cur_show.network:
                                    <span title="${cur_show.network}"><img class="show-network-image" src="images/network/nonetwork.png" layz="on" asset="show/${cur_show.indexerid}?type=network&api_key=${app.API_KEY}" alt="${cur_show.network}" title="${cur_show.network}" /></span>
                                % else:
